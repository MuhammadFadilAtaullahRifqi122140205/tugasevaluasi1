...
const (
	...
	PaymentService_RefundPayment_FullMethodName    = "/paymentservice.PaymentService/RefundPayment"
	PaymentService_SuccessPayment_FullMethodName   = "/paymentservice.PaymentService/SuccessPayment"
	PaymentService_GetPaymentStatus_FullMethodName = "/paymentservice.PaymentService/GetPaymentStatus"
)
...
type PaymentServiceClient interface {
	...
	GetPaymentStatus(ctx context.Context, in *GetPaymentStatusResponse, opts ...grpc.CallOption) (*GetPaymentStatusResponse, error)
}
...
func (c *paymentServiceClient) SuccessPayment(ctx context.Context, in *SuccessPaymentRequest, opts ...grpc.CallOption) (*SuccessPaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SuccessPaymentResponse)
	err := c.cc.Invoke(ctx, PaymentService_SuccessPayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentServiceClient) GetPaymentStatus(ctx context.Context, in *GetPaymentStatusResponse, opts ...grpc.CallOption) (*GetPaymentStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PaymentServiceServer interface {
	...
	GetPaymentStatus(context.Context, *GetPaymentStatusResponse) (*GetPaymentStatusResponse, error)
...
func (UnimplementedPaymentServiceServer) SuccessPayment(context.Context, *SuccessPaymentRequest) (*SuccessPaymentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SuccessPayment not implemented")
}
func (UnimplementedPaymentServiceServer) GetPaymentStatus(context.Context, *GetPaymentStatusResponse) (*GetPaymentStatusResponse, error) {
...
func _PaymentService_SuccessPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuccessPaymentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).SuccessPayment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_SuccessPayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).SuccessPayment(ctx, req.(*SuccessPaymentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_GetPaymentStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPaymentStatusResponse)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetPaymentStatus(ctx, req.(*GetPaymentStatusResponse))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PaymentService_SuccessPayment_Handler,
		},
		{
