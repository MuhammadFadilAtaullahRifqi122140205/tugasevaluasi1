...
const (
	ShippingService_StartShipping_FullMethodName  = "/shippingservice.ShippingService/StartShipping"
	ShippingService_CancelShipping_FullMethodName = "/shippingservice.ShippingService/CancelShipping"
	ShippingService_Shipped_FullMethodName        = "/shippingservice.ShippingService/Shipped"
)
...
type ShippingServiceClient interface {
	...
	Shipped(ctx context.Context, in *ShippedRequest, opts ...grpc.CallOption) (*ShippedResponse, error)
}
...
func (c *shippingServiceClient) Shipped(ctx context.Context, in *ShippedRequest, opts ...grpc.CallOption) (*ShippedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShippedResponse)
	err := c.cc.Invoke(ctx, ShippingService_Shipped_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServiceServer interface {
	...
	Shipped(context.Context, *ShippedRequest) (*ShippedResponse, error)
...
func (UnimplementedShippingServiceServer) Shipped(context.Context, *ShippedRequest) (*ShippedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Shipped not implemented")
}
...
func _ShippingService_Shipped_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShippedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).Shipped(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShippingService_Shipped_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).Shipped(ctx, req.(*ShippedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShippingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Shipped",
			Handler:    _ShippingService_Shipped_Handler,
		},
	},
